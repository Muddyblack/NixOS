...
Item {
    ...
    Plasma5Support.DataSource {
        ...
        function spawn() { connectSource("@FEEDER@") }
    }
    ...
    Plasma5Support.DataSource {
        ...
        function read() { connectSource('cat "${XDG_RUNTIME_DIR:-/tmp}/audio-wave-widget/bars"') }
    }
    ...
    Component.onDestruction: {
        feederLauncher.connectSource("@PKILL@ -f audio-wave-feeder")
    }
}
